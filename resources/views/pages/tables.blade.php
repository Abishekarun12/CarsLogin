...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Cars Tables'])
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $car ->manufacturer }}</h6>
                                                    <p class="text-xs text-secondary mb-0">Familiar</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0"><strong>{{ $car ->model }}</strong></p>
                                            <p class="text-xs text-secondary mb-0">Organization</p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm bg-gradient-success">{{ $car ->launch_status }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $car ->launch_year }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <a href="{{ route('cars.edit', ['car' => $car])}}" class="text-secondary font-weight-bold text-xs"
